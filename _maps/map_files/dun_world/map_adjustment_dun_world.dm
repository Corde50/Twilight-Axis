...
/datum/map_adjustment/template/dunworld
	...
	blacklist = list(/datum/job/roguetown/royal_guard, /datum/job/roguetown/sheriff, /datum/job/roguetown/town_watch, /datum/job/roguetown/vanguard, /datum/job/roguetown/courtphysician, /datum/job/roguetown/knight_enigma, /datum/job/roguetown/royal_sergeant, /datum/job/roguetown/overseer, /datum/job/roguetown/dungeoneer)
