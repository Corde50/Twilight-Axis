...
var/global/list/ERP_ACTION_EDITOR_FIELDS = list(
	...
	list("id"="tick_time",   "label"="Tick time (сек)", "type"="number", "section"="Тайминг", "min"=0.1, "max"=20, "step"=0.1),
	list("id"="continuous",  "label"="Непрерывное",     "type"="bool",   "section"="Тайминг"),
