/datum/erp_action/other/penis/hemi
	abstract_type = TRUE
	stamina_cost = 0.4
	name = "Корневое действие гемипенисом"

/datum/erp_action/other/penis/hemi/proc/has_hemi_penis(mob/living/carbon/human/human_object)
	if(!human_object)
		return FALSE
...
/datum/erp_action/other/penis/hemi/shows_on_menu(mob/living/carbon/human/user, mob/living/carbon/human/target)
	if(!..())
		return FALSE
