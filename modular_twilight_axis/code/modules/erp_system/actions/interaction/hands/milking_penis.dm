/datum/erp_action/other/hands/milking_penis
	...
	message_start  = "{actor} {pose} кладет руки на член {target}."
	message_tick   = "{actor} {pose}, {force} и {speed} водит руками по члену {target}."
	message_finish = "{actor} убирает руки от члена {target}."
	message_climax_passive = "{target} кончает в руках {actor}."
