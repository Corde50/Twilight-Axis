...
/datum/antagonist/zizocultist/on_gain()
	...
	if(!change_stats)
		return
	H.adjust_skillrank(/datum/skill/combat/knives, 4, 4, TRUE)
	H.adjust_skillrank(/datum/skill/combat/swords, 4, 4, TRUE)
	H.adjust_skillrank(/datum/skill/combat/wrestling, 5, 5, TRUE)
	H.adjust_skillrank(/datum/skill/misc/athletics, 4, 4, TRUE)
	H.change_stat(STATKEY_STR, 2)
	H.change_stat(STATKEY_STR, 2)
