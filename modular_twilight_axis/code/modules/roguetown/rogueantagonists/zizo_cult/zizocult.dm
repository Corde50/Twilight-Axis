...
/datum/antagonist/zizocultist/on_gain()
	...
	if(islesser)
		...
		if(!change_stats)
			return
		H.adjust_skillrank(/datum/skill/combat/knives, 2, 3, TRUE)
		H.adjust_skillrank(/datum/skill/combat/swords, 2, 3, TRUE)
		H.adjust_skillrank(/datum/skill/combat/polearms, 2, 3, TRUE)
	...
	if(!change_stats)
		return
	H.adjust_skillrank(/datum/skill/combat/knives, 2, 2, TRUE)
	H.adjust_skillrank(/datum/skill/combat/swords, 2, 2, TRUE)
	H.adjust_skillrank(/datum/skill/combat/wrestling, 3, 4, TRUE)
	H.adjust_skillrank(/datum/skill/misc/athletics, 2, 2, TRUE)
	H.change_stat(STATKEY_STR, 2)
