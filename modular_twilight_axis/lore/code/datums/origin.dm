...
/datum/virtue/origin/racial/underdark
	...
	origin_desc = "Глубоко под поверхностью Гримории, там, куда не добирается свет Астраты и Нок, находится Подземье — огромная сеть пещер, простирающаяся почти под всей территорией Западных Королевств. Исследование бесчисленных загадок этого места существенно осложняется тем, что с незапамятных времён Подземье является пристанищем и домом для народа дроу, чьи величественные подземные города зачастую оказываются смертельной ловушкой для неосторожных путников.<br>С точки зрения структуры Подземье разделено на три уровня:<br>Верхнее Подземье представляет собой условный вход на более глубокие уровни. Чаще всего это древние пещеры и катакомбы, подвалы с потайными ходами и храмы, древние руины и тому подобное. Там можно встретить всех, но чаще всего авантюристов и контрабандистов, которые пользуются его ходами для преодоления больших расстояний вне поверхности, к которому оно ближе всего.    <br>Среднее Подземье находится на порядок глубже, примерно до 15 миль в мрак и глубину. Это место, где никогда не светит солнце, а источники воды считаются роскошью. Тут обитают как дроу, так и более опасные существа. Пурпурные черви выкапывают все новые и новые ходы в поисках добычи, умберхалки, они же огромных размеров кроты, вместо морковки пожирают ноги заблудившихся путников, бехолдеры, они же огромные глаза с множеством щупалец, которые своим взглядом порабощают и превращают в живые статуи — лишь малая часть того, что ждет неподготовленного заблудившегося шахтера.<br>Нижнее Подземье — место, откуда никто не возвращался, во всяком случае в здравом уме. Даже самые опасные твари Среднего Подземья неохотно посещают это место. В вечной тьме рассеиваются иллюзии, а свет быстро угасает, магические аномалии искажают пространство и время, искажая тело и разум неосторожного путника."
...
/datum/virtue/origin/racial/akhdruk
	...
	races = list(/datum/species/dwarf/mountain,
				/datum/species/dwarf/gnome)
	origin_desc = "Наиболее важным объектом, на кои обращается внимание в дворфийском обществе, обычно выступает сумма трёх вещей: возраст, богатство и мастерство. Чем больше у дворфа этих качеств, тем выше его положение в обществе. Но дворфы не хвастаются достижениями своих семей.<br>Дворфы питают привязанность к прошлому и традициям своего народа и постоянно стремятся помнить своих предков, ремонтируя и поддерживая свои изделия. Все кузнецы этого народа умеют перековывать древние оружие и постоянно пытаются использовать древние реликвии в своих новых работах. Все самые мощные из этих видов оружия выкованы из черностали.<br>Дворфы обладают жестким и непреклонным чувством чести, которое сосредоточено вокруг клятв или обещаний. Обещание не умирает вместе с клятвопреступником, как и предательство не умирает вместе с нарушителем клятвы. Дворф будет связан невыполненным обещанием, данным предком, и обязуется его исполнить. Точно так же они будут искать возмещения у потомков нарушителей клятвы.<br>Серьезные нарушения веры или закона зафиксированы в Книге обид. Каждый уважающий дворф должен носить личную книгу, для записи личных обид, нанесенных ему кем или чем-либо."
