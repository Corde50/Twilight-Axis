...
/datum/round_event/antagonist/solo/aspirants/start()
	...
	var/list/helping = list("Consort" ,"Hand" ,"Suitor" ,"Prince" ,"Captain" ,"Steward" ,"Court Magician ","Archivist", "Knight","Knight(Enigma)", "Marshal", "Councillor", "Town Crier", "Keeper", "Veteran")
