...
#define BLUNT_LOWER_PENFACTOR 0 // TA
#define BLUNT_NO_PENFACTOR -100 // TA
#define NONBLUNT_BLUNT_DAMFACTOR 0.6 // Damage factor when a non blunt weapon is used with blunt intent. Meant to make it worse than a real one. // TA edit, 0.7
#define BLUNT_DEFAULT_INT_DAMAGEFACTOR 1.2 // Universal blunt intent integrity damage factor. Replaces Roguepen // TA edit, 1.6
