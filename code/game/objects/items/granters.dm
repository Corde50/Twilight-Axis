...
/obj/item/book/granter/residentcard //TA_EDIT
...
/obj/item/book/granter/residentcard/attack_self(mob/living/user) //TA_EDIT
...
/obj/item/book/granter/residentcard/onlearned(mob/living/carbon/user) //TA_EDIT
	..()
	if(oneuse == TRUE)
